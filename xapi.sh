...
add_chaotic_aur() {
    if ! grep -q "\[chaotic-aur\]" /etc/pacman.conf; then
        ...
        sudo pacman -U --noconfirm 'https://mirrors.aliyun.com/chaotic-aur/chaotic-keyring.pkg.tar.zst'
        sudo pacman -U --noconfirm 'https://mirrors.aliyun.com/chaotic-aur/chaotic-mirrorlist.pkg.tar.zst'
